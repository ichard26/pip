...
def test_show_required_by_packages_basic(
    ...
    """
    script.pip_install_local(data.find("src/requires_simple"))
...
def test_show_required_by_packages_capitalized(
    ...
    """
    script.pip_install_local(data.find("src/requires_capitalized"))
...
def test_show_required_by_packages_requiring_capitalized(
    ...
    """
    script.pip_install_local(data.find("src/requires_capitalized"))
    script.pip_install_local(data.find("src/requires_requires_capitalized"))
...
def test_show_license_expression(script: PipTestEnvironment, data: TestData) -> None:
    ...
    """
    script.pip_install_local(data.find("license.dist-0.1-py2.py3-none-any.whl"))
...
def test_show_license_for_metadata_24(
    ...
    """
    script.pip_install_local(data.find("license.dist-0.2-py2.py3-none-any.whl"))
    result = script.pip("show", "license.dist")
    lines = result.stdout.splitlines()
